...
public class EmpController {
	...
	@GetMapping("/fullname")
	public ResponseEntity<List<empDto>> getEmpsByFullName(@RequestParam String fullname)
	{
...
//	@GetMapping("/search")
//	public ResponseEntity<List<empDto>> getEmpsBySearch(@RequestParam("query") String query)
//	{
//		List<empDto> emps=empservice.getBySearchQuery(query);
//		if(emps.isEmpty())
//				return new ResponseEntity<>(HttpStatus.NOT_FOUND);		
//		else
//			return new ResponseEntity<>(empservice.getBySearchQuery(query),HttpStatus.OK);
//		//return ResponseEntity.ok();
//	}
